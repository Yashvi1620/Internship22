    ...
    <nav id="sidebar" class="sidebar js-sidebar">
      <div class="sidebar-content js-simplebar">
        ...
        {/* <ul class="sidebar-nav">
          <li class="sidebar-header">List</li>
          ...
          <li class="sidebar-item">
            <Link classNamex="sidebar-link flex" to="/User">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <li class="sidebar-item ">
            <Link class="sidebar-link" to="/Project">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <li class="sidebar-item">
            <Link class="sidebar-link" to="/Project-Team">
              ...
              <span class="align-middle">Project-Team</span>
            </Link>
          </li>

          <li class="sidebar-item">
            <Link class="sidebar-link" to="/User-Task">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              <span class="align-middle">User-Task</span>
            </Link>
          </li>
          ...
          <li class="sidebar-item">
            <Link class="sidebar-link" to="/Priority">
              ...
              <span class="align-middle">Priority</span>
            </Link>
          </li>

          <li class="sidebar-item">
            <Link class="sidebar-link" to="/ProjectModule">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              <span class="align-middle">ProjectModule</span>
            </Link>
          </li>
          ...
          <li class="sidebar-item">
            <Link class="sidebar-link" to="/Tasks">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
